...
namespace RPP
{
    public partial class ReporteAsignadasRango : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            List<Prelacion> prelaciones = Prelacion.ObtenerPrelacionesEstatusFechaReporteRango("%", fechaInicio, fechaFin);
            ...
            if (prelaciones.Count > 0)
            {
                ...
                for (int i = 0; i < prelaciones.Count; i++)
                {
                    if (registradorActual == prelaciones[i].Usuario)
                    {
                        ...
                        Response.Write("<td>" + prelaciones[i].Usuario + "</td>");
                    ...
                    else
                    {
                        ...
                        Response.Write("<td><B>Asignado a</B></td>");
