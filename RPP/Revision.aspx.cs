...
namespace RPP
{
    public partial class Revision : System.Web.UI.Page
    {
        ...
        protected void gvPrelaciones_PageIndexChanged(object sender, EventArgs e)
        {

        }

        protected void gvPrelaciones_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
